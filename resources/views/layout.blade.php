...
<html lang="en">
	<head>
		<title>Workforce Management Common Resource</title>
		<meta charset="utf-8" />
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
																...
																<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
																	...
																	<div class="menu-item">
																		<a class="menu-link py-3" href="../../demo2/dist/pages/profile/followers.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
															...
															<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
																...
																<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
																	...
																	<div class="menu-item">
																		<a class="menu-link py-3" href="../../demo2/dist/pages/wizards/two-factor-authentication.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
																	...
																	<div class="menu-item">
																		<a class="menu-link py-3" href="../../demo2/dist/pages/wizards/create-app.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
																	...
																	<div class="menu-item">
																		<a class="menu-link py-3" href="../../demo2/dist/pages/wizards/create-account.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
																	...
																	<div class="menu-item">
																		<a class="menu-link py-3" href="../../demo2/dist/pages/wizards/create-project.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
																	...
																	<div class="menu-item">
																		<a class="menu-link py-3" href="../../demo2/dist/pages/wizards/offer-a-deal.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															...
															<div class="menu-item">
																<a class="menu-link active py-3" href="../../demo2/dist/account/security.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
							...
							<div class="page-title d-flex flex-column me-3">
								...
								<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
									<li class="breadcrumb-item text-gray-600">
                                        <a  class="text-gray-600 text-hover-primary">{{ ucwords(Request::segment(0)) ? : 'View' }}</a>
                                    </li>
                                    <li class="breadcrumb-item text-gray-600">{{ ucwords(str_replace(['-', '_'], ' ', Request::segment(1))) ? : 'Home' }}</li>
                                    @if (Request::segment(2))
                                    <li class="breadcrumb-item text-gray-500">{{ ucwords(str_replace(['-', '_'], ' ', Request::segment(2))) ? : 'Pages' }}</li>
                                    @endif
                                    @if (Request::segment(3))
                                    <li class="breadcrumb-item text-gray-400">{{ ucwords(str_replace(['-', '_'], ' ', Request::segment(3))) ? : 'Sub Pages' }}</li>
                                    @endif
								</ul>
							</div>
						</div>
